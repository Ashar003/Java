...
public class Lab11 {
   ...
   int row = 0;
    int sum = 0;
   String[][] strMatrix = new String[myMatrix.length][myMatrix[row].length];

    for(int iRow = 0; iRow< myMatrix.length; iRow++){
       for(int col = 0; col< myMatrix[iRow].length; col++){
           strMatrix[iRow][col] = String.valueOf(myMatrix[iRow][col]);
           sum = sum + myMatrix[iRow][col];
       }
    }
   ...
   for(int iRow = 0; iRow< myMatrix.length; iRow++){
       for(int col = 0; col< myMatrix[iRow].length; col++){
            ...
            myText.append(strMatrix[iRow][col]);
   ...
   myLabel.setText("The sum is " + String.valueOf(sum));
