...
/*
            ...
            iDate is set equal to the constructor with the string passed in from JOptionPane, and that is appended to the unsorted.
            Then, using the "put" method on the treeMap, the Key: iDate and Value: p is mapped together.
    */
    ...
    public class DateComparator implements Comparator <Date212>  {
     ...
     /*
     The comparator class which is the basis for comparing the dates within the treeMap.
     It compares using the Date212 method 'compare', and the Date212(keys) which are in the treeMap.
     Based on the return value, the treeMap sorts values(p) around.
     */
